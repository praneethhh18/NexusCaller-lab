...
PRESETS: list[Combo] = [
    ...
    Combo(
        key="cheap-llama-3b",
        label="💰 Llama 3.2 3B  (enable in console first)",
        description="Nova-3 STT · Meta Llama 3.2 3B (Bedrock) · Aura-2. Smallest Meta model. NOTE: needs Model access enabled at console.aws.amazon.com/bedrock.",
        stt="deepgram-nova-3",
...
LLM_OPTIONS = [
    ...
    {"key": "bedrock-us.meta.llama3-2-3b-instruct-v1:0",
                                          "label": "Bedrock · Llama 3.2 3B  (needs Model Access enabled)",
     "group": "Cloud — AWS Bedrock"},
