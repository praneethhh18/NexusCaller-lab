...
PRESETS: list[Combo] = [
    Combo(
        key="fast-deepgram-llama4-aura",
        label="Fast (Llama 4 Maverick + Aura)",
        description="Nova-3 STT · Llama 4 Maverick 17B (MoE) on SambaNova · Aura-2 Asteria TTS. Lowest latency — target ~900ms per reply.",
        stt="deepgram-nova-3",
        llm="sambanova-Llama-4-Maverick-17B-128E-Instruct",
...
LLM_OPTIONS = [
    ...
    {"key": "cerebras-llama3.1-70b",               "label": "Cerebras · Llama 3.1 70B  (free, high quality)",
     "group": "Cloud — Cerebras"},
    {"key": "sambanova-Llama-4-Maverick-17B-128E-Instruct", "label": "SambaNova · Llama 4 Maverick 17B  (free, fastest)",
